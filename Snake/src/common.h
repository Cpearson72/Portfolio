...
extern long unsigned int g_snake_head_x;
extern long unsigned int g_snake_head_y;

extern int* g_snake_head;
//in order NESW 0123
extern int g_snake_dir;

extern int snake_malloced;

extern int new_board;
...
typedef struct snake {
    ...
    //set head to start of linked list
    node_t* snake_head;
    int snake_dir;
